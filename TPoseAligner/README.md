...
레포 루트의 통합 인스톨러(`install_menus.py`)를 사용합니다. Retargeter,
TPoseAligner 등 모든 도구의 메뉴를 한 번에 **Tools** 메뉴 아래에
등록합니다. 자세한 설치 방법(PowerShell symlink 등)은
[`../README.md`](../README.md) 의 "Quick install" 섹션 참고.

설치 후 **Tools → TPose Align → T-Pose Pair Align...** 등으로 접근합니다.
